...
Public Class landReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Member Land Report")
        item = Dg.Items.Add("Member Land survey No Report")
        item = Dg.Items.Add("Mangna From")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        'End If
        If Dg.SelectedItems(0).SubItems(0).Text = "Member Land Report" Then
            ssql = ""
            ...
            clsVariables.Repheader = "Member Land Report"
            clsVariables.ReportName = "MemberLandReport.rpt"
            Dim frm As New Reportform
            frm.Show()
            '
        ElseIf Dg.SelectedItems(0).SubItems(0).Text = "Member Land survey No Report" Then
            ssql = ""
            clsVariables.ReportSql = ssql
            clsVariables.FromDate = TxtfromDate.Text
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.PassAccId = Val(Membname.Tag)
            clsVariables.Repheader = "Member Land Report survey wise"
            clsVariables.ReportName = "MemberLandReportSrno.rpt"
            Dim frm As New Reportform
            frm.Show()
        Else
            ssql = ""
            ...
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.PassAccId = Val(Membname.Tag)
            clsVariables.Repheader = "Mangna From"
            clsVariables.ReportName = "MemberMangnaAplicationFrom.rpt"
            Dim frm As New Reportform
            frm.Show()
        End If
    End Sub
