...
Public Class TrialBalanceReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Trial Balance Report")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Dg.SelectedItems(0).SubItems(0).Text = "Trial Balance Report" Then
            tarij()
            ssql = "{Joint_Trial_Balance.Company_id}=" & clsVariables.CompnyId
            clsVariables.ReportSql = ssql
            clsVariables.FromDate = TxtfromDate.Text
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Trial Balance Report"
            clsVariables.ReportName = "FinalTrialBalance.rpt"
    ...
    Public Sub tarij()
        ...
        If dtcr.Rows.Count > 0 Then
            For i As Integer = 0 To dtcr.Rows.Count - 1
                ...
                If bal > 0 Then
                    ob.Execute("INSERT INTO Joint_Trial_Balance(Company_id,Account_Id,HO_Dr,Ho_Cr) Values(1," & dtcr.Rows(i).Item("ACid") & ",0," & bal & ")", ob.getconnection())
                Else
