...
Public Class OldMangnaReceipt
    ...
    Private Sub Billno_KeyDown(sender As Object, e As KeyEventArgs) Handles Txtremark.KeyDown, Fixno.KeyDown, cmbtype.KeyDown, Billno.KeyDown, billDt.KeyDown, sname.KeyDown, txtvillageid.KeyDown, txtcolumn.KeyDown, Billamt.KeyDown, txtdisamt.KeyDown, intamt.KeyDown, netamt.KeyDown
